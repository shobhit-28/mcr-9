...
export const RestOfTheVideosCard = ({video}) => {
  ...
  return (
    <div className="flex gap-2 cursor-pointer hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)] shadow-[0_1px_5px_rgb(0,0,0,0.2)] duration-500 p-2 mx-2 rounded-lg" onClick={() => navigate(`/video-${video?._id}`)}>
